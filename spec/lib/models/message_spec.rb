...
describe "message responses" do
  it 'should display processor_transaction_success' do
    message = Ronin::Message.new(:subclass=>'info', :context=>'processor.transaction', :key=>'success')
    message.description.should == 'The transaction was successful.'
  end
  it 'should display processor_transaction_declined' do
    message = Ronin::Message.new(:subclass=>'error', :context=>'processor.transaction', :key=>'declined')
    message.description.should == 'The card was declined.'
  end
  it 'should display processor_issuer_call' do
    message = Ronin::Message.new(:subclass=>'error', :context=>'processor.issuer', :key=>'call')
  ...
  it 'should display input_expiry_month_invalid' do
    message = Ronin::Message.new(:subclass=>'error', :context=>'input.expiry_month', :key=>'invalid')
  ...
  it 'should display input_expiry_year_invalid' do
    message = Ronin::Message.new(:subclass=>'error', :context=>'input.expiry_year', :key=>'invalid')
  ...
  it 'should display input_amount_invalid' do
    message = Ronin::Message.new(:subclass=>'error', :context=>'input.amount', :key=>'invalid')
