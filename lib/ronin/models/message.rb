...
# Simple class for serializing Ronin <message> responses
class Ronin::Message
  attr_accessor :attributes, :context, :subclass, :key

  def initialize(attributes)
    @key = attributes.with_indifferent_access['key']
    @context = attributes.with_indifferent_access['context']
    @subclass = attributes.with_indifferent_access['subclass']
  end
